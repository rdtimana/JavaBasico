...
public class ListaDobleGenerica {
     ...
     * @param pos
     * @return int //valor del nodo a extraer
     */
    ...
    /**
     * Metodo para consultar el valor mayor de una lista
     * @return
     */
    public int mayor () {
        if (!vacia ()) {
    ...
    /**
     * Metodo para consultar la posición del valor mayor en una lista
     * @return
     */
    public int posMayor() {
        if (!vacia ())    {
    ...
    /**
     * Validar si la lista se encuentra ordenada
     * @return
     */
    ...
    /**
     * Imprimir los valores de una lista contenidos en los nodos
     */
	...
	public static void main(String[] args) {
		ListaDobleGenerica lg=new ListaDobleGenerica();
        lg.insertar (1, 10);
        lg.insertar (2, 20);
        lg.insertar (3, 30);
        lg.insertar (2, 15);
